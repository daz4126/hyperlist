...
var view = function view(state, actions) {
  return (0, _hyperapp.h)(
    ...
    (0, _hyperapp.h)(AddItem, { add: actions.add, input: actions.input,
      value: state.input }),
    (0, _hyperapp.h)(
      'ul',
      { id: 'list' },
...
},{"./css/index.scss":4,"hyperapp":8,"./js/state.js":5,"./js/actions.js":6,"./js/view.js":7}],16:[function(require,module,exports) {
...
//# sourceMappingURL=/src.23fa8558.map